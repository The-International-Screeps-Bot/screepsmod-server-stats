...
function HandleOwnedRoomsObjectsStats(stats, objects) {
...
function HandleReservedRoomsObjectsStats(stats) {
    return stats
}

module.exports = function HandleRoomsObjectsStats(stats, objects, roomType) {
    ...
    switch (roomType) {
        case "owned":
            stats = HandleOwnedRoomsObjectsStats(stats, objects)
            break;
        case "reserved":
            stats = HandleReservedRoomsObjectsStats(stats, objects)
            break;
        default:
            break;
    }
