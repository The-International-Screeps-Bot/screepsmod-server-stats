      ...
      switch (intentType) {
         ...
         case "transfer":
            if (actualIntent.resourceType === 'energy') {
               log(`${intentType === "transfer" ? "energyIncome" : "energyOutflow"}, type: ${intentType}, type2: ${actualIntent.resourceType}, amount: ${actualIntent.amount}, obj: ${JSON.stringify(stats[intentType === "transfer" ? "energyIncome" : "energyOutflow"])}`, "test.log")
