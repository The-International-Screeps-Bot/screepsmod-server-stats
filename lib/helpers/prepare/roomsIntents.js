      ...
      switch (intentType) {
         ...
         case "transfer":
            if (actualIntent.resourceType === 'energy') {
               log(`${intentType === "transfer" ? "energyInflow" : "energyOutflow"}, type: ${intentType}, type2: ${actualIntent.resourceType}, amount: ${actualIntent.amount}, obj: ${JSON.stringify(stats[intentType === "transfer" ? "energyInflow" : "energyOutflow"])}`, "test.log")
               stats[intentType === "transfer" ? "energyInflow" : "energyOutflow"][intentType][actualIntent.resourceType] += actualIntent.amount
            }
            break;
